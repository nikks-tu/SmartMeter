...
public class RechargeCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //rechargeAmount = getIntent().getStringExtra(Constants.RECHARGE_AMOUNT);
    ...
    private void init() {
        context = RechargeCompleteActivity.this;
