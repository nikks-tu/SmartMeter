...
public class ScrachCardInsertPostParameters {
    ...
    public ScrachCardInsertPostParameters(String USN_No, String rechargePlan, String rechargeCode, String paidBy, String remarks) {
        this.USN_No = USN_No;
