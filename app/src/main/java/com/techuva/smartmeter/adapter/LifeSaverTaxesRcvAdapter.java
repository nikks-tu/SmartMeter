...
public class LifeSaverTaxesRcvAdapter extends RecyclerView.Adapter<LifeSaverBreakupRCVHolder>
{
    ...
    public LifeSaverTaxesRcvAdapter(Context context, ArrayList<LifeSaverCalculationBreakup> arrayList) {
